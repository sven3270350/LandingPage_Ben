            ...
            <div className="w-[425px] flex justify-center items-center p-8 flex-col gap-8 rounded-xl bg-white">
                ...
                <div className="w-full">
                    ...
                    <div className="relative">
                        <input onChange={(e) => setPassword(e.target.value)} type={isPasswordVisible ? "text" : "password"} id="password" className="bg-[#F0F0F0] border border-gray-300 text-black text-sm block w-full px-3 py-2 rounded-xl" placeholder="Enter your password" required />
