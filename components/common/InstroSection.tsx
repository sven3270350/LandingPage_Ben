...
const IntroSection = () => {
  ...
  return (
    <div className="w-full">
      ...
      >
        <Image
          className={cx("absolute top-[20%] left-[5%]",isTablet? "hidden": "block")}
          width={650}
          height={200}
        ...
        <div className={cx("absolute text-white left-[5%] text-start",
         isTablet ? "opacity-100 text-xl leading-6 not-italic top-[25%] w-[217px]" : "top-[75%] opacity-[.8] font-robotic text-4xl tracking-wide" )}>
          Automated tool to easily manage, raise, {!isTablet && <br />}invest and trade cryptocurrency assets
        </div>
      </div>
