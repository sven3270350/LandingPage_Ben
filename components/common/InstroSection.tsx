...
const IntroSection: React.FC<IntroSectionProps> = ({ handleSlideToTwo, activeSlide }) => {
    ...
    <div className="w-full bg-firstSection h-full flex justify-center">
      <div className="max-w-[1560px] w-full">
        <div className="relative h-[100vh]">
          <Image
            className={cx("absolute top-[20%] left-[8%]", activeSlide === 0 && "animate-normal-animation duration-1000")}
            width={650}
            height={279.92}
          ...
          <button
            type="button"
            className={cx("absolute fuller-button blue top-[60%] left-[17%] rounded-3xl text-white flex justify-center items-center flex-shrink-0 w-[324px] py-2 px-6 font-normal text-base shadow-[0_4px_9px_-4px_#54b4d3] transition duration-150 ease-in-out hover:bg-info-600 hover:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] focus:bg-info-600 focus:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] focus:outline-none focus:ring-0 active:bg-info-700 active:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(84,180,211,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.2),0_4px_18px_0_rgba(84,180,211,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.2),0_4px_18px_0_rgba(84,180,211,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.2),0_4px_18px_0_rgba(84,180,211,0.1)]", activeSlide === 0 && "animate-normal-animation duration-1000")}
          >
