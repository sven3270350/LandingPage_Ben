    ...
    <div>
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="text-[#2F4644] font-normal text-[52px] !leading-[120%] tracking-[-2px]">
          Learn about our account proposals
        </div>
        <div className="text-[#2F4644] text-2xl font-light !leading-[120%] tracking-[-2px] mb-10">
          Get the most out of cryptool
        </div>
      </div>
      <div className="flex flex-wrap justify-center items-center gap-6 mb-24 mt-16 lg:mx-40 mx-0">
        {plans.map((item, index) => {
          return (
            <div
              key={index}
              className="flex flex-col col-auto w-[410px] h-[489px]"
            >
              ...
              <div className="text-[#54716F] text-base not-italic font-normal mb-20">
                {item.label}
              </div>
              ...
              <button
                type="button"
                className="inline-block rounded-3xl text-[#2F4644] bg-[#00f2de] py-2 font-normal text-base shadow-[0_4px_9px_-4px_#54b4d3] transition duration-150 ease-in-out hover:bg-info-600 hover:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] focus:bg-info-600 focus:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] focus:outline-none focus:ring-0 active:bg-info-700 active:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(84,180,211,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.2),0_4px_18px_0_rgba(84,180,211,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.2),0_4px_18px_0_rgba(84,180,211,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.2),0_4px_18px_0_rgba(84,180,211,0.1)]"
              >
                {item.btnLabel}
              </button>
            </div>
